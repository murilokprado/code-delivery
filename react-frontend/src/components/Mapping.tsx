...
import { FormEvent, FunctionComponent, useCallback, useEffect, useState, useRef } from "react";
        ...
        <Grid className={classes.root} container >
          <Grid item xs={12} sm={3}>
            ...
            <form className={classes.form} onSubmit={startRoute}>
                ...
                <Button className={classes.btnSubmitWrapper} type="submit" color="primary" variant="contained">
                  Iniciar uma corrida
                </Button>
            </form>
          </Grid>
